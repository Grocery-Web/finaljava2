...
public class RelevantCriminalForm extends JDialog {
	...
	private RelevantCriminalFormListener revListener;
	...
	public RelevantCriminalForm(Person per, List<Complaint> incidentList) {
		...
		okBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (revListener != null) {
					revListener.criminalFormEventListener(comDetail, cri);
				}
			}
		});
	...
	public void setFormListener(RelevantCriminalFormListener revListener) {
